...
from open_spiel.python.algorithms import cfr_opt_reg
...
flags.DEFINE_integer("update_count", 50, "Number of updated infos each epsiode")
...
def main(_):
  ...
  cfr_solver = cfr_opt_reg.CFRSolver(game, update_count=FLAGS.update_count)

  path_name = "../data/cfr_opt_reg_mc_{}_{}/".format(FLAGS.update_count, FLAGS.game)
