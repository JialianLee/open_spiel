...
from open_spiel.python.algorithms import cfr_full_rp_cur
...
def main(_):
  ...
  cfr_solver = cfr_full_rp_cur.CFRSolver(game)

  path_name = "../data/cfr_full_rp_cur_{}/".format(FLAGS.game)
  ...
  # info_state_node = cfr_solver._info_state_nodes.get(info_state)
